'''
Author: Zixuan Ye 1723489846@qq.com
Date: 2022-08-18 17:04:33
LastEditors: YeZixuan
LastEditTime: 2022-11-20 14:04:54
FilePath: /yezixuan/a2u_matting/scripts/config/default.py
...
_C.DATASET.test_dir = '/media/yutong/DATA/data/datasets/Combined_Dataset'
...
_C.DATASET.composition_style = None
# -----------------------------------------------------------------------------
# Model
# -----------------------------------------------------------------------------
_C.MODEL = CN()
...
_C.MODEL.upsample = 'nearest'
_C.MODEL.channel_reference = False
_C.MODEL.pretrained_dir = None
_C.MODEL.adjust_color_scale = True
# -----------------------------------------------------------------------------
# Training
# -----------------------------------------------------------------------------
_C.TRAIN = CN()
